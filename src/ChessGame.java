...
public class ChessGame {
    ...
    public List<Position> getLegalMovesForPieceAt(Position position) {
        ...
        switch (selectedPiece.getClass().getSimpleName()) {
            ...
            case "Knight":
                ...
                break;
            case "Bishop":
                    addBishopMoves(selectedPiece.getColor(),position,legalMoves);
                    break;
            case "Queen":
    ...
    private void addBishopMoves(PieceColor color, Position position, List<Position> legalMoves) {
        int[][] directions;
        if (PieceColor.BLACK == color) {
            directions = new int[][]{{-1, 1}, {0, -2}, {1, -1}, {2, 0}, {1, 1}, {0, 2}};
        } else {
            directions = new int[][]{{-1, -1}, {-2, 0}, {-1, 1}, {0, -2}, {1, -1}, {0, 2}};
        }
        addSingleMoves(position, directions, legalMoves);
    }
